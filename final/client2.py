...
# Client identifier
client_id = "Client_2"  # Change to "Client_2" for the second client
...
for epoch in range(12):  # Adjust epochs as needed
    ...
    response = requests.post("http://localhost:5001/process_activations", json={"client_id": "Client_2", "activations": initial_activations.numpy().tolist()})
